...
<form action ="../configur/insert.php" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control"  value=""  id ="Nama" name="namaPemilik">
    </div>
    <div class="mb-3">
        <b><label for="exampleFormControlInput1" class="form-label">Merk</label></b>
        <input type="text" class="form-control"  value="" id ="start time" name="merk">
    </div>
    <div class="mb-3">
    ...
    <input class="form-check-input" type="radio" name="statuspembayaran" id="inlineRadio1" value="option1">
    <label class="form-check-label" for="inlineRadio1">Lunas</label>
    </div>
    <div class="form-check form-check-inline">
    <input class="form-check-input" type="radio" name="statuspembayaran" id="inlineRadio2" value="option2">
